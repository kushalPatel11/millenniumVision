...
video_file = '/Dataset/all videos/1.mp4'  # Change to your video file

# Example: Find the frame at 52 seconds
start_frame = time_to_frame(video_file, 26)
# print(f"Start Frame: {start_frame}")

end_frame = time_to_frame(video_file, 28)
...
extract_clips(video_file, start_frame, end_frame, 'Dataset/headshot/h3.mp4')
